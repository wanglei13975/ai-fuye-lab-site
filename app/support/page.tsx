...
export default function SupportPage() {
  return <main>
    <nav className="nav wrap"><Link className="brand" href="/"><span className="mark">AI</span> AI副业实验室</Link><div className="navLinks"><Link href="/">返回首页</Link><Link href="/privacy">隐私政策</Link></div></nav>
    <article className="legal wrap">
      ...
      <h2>法律与隐私</h2><p>有关本地数据、StoreKit 交易状态和第三方链接的说明，请阅读<Link href="/privacy">隐私政策</Link>。</p>
    </article>
    <footer className="wrap"><span>© 2026 AI副业实验室</span><div><Link href="/">首页</Link><Link href="/privacy">隐私政策</Link></div></footer>
  </main>;
}
