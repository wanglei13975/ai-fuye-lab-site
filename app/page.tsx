    ...
    <main>
      ...
      <section className="hero wrap" id="top">
        <div>
          ...
          <p className="priceNote">Free to start · Annual Pro $29.99/year · limited Lifetime Pro $5.99 through September 25, 2026</p>
      ...
      <section className="offer wrap" aria-label="App purchase information">
        ...
        <div className="offerBody"><p>Download and start for free. Create a 7-day plan, then open Execute Toolkit to unlock copyable client templates. In the US, Annual Pro is $29.99/year and the limited Lifetime Pro offer is $5.99 through September 25, 2026. The App Store is the source of truth for final availability, price, and billing details.</p><a className="cta light" href={appStoreUrls.offer} target="_blank" rel="noreferrer">Download free <span>↗</span></a></div>
      </section>
