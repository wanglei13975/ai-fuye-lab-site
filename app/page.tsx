  ...
  return (
    <main>
      <nav className="nav wrap">
        ...
        <div className="navLinks"><a href="#projects">Guides</a><a href={appStoreUrls.nav} target="_blank" rel="noreferrer">Get the app</a><a href="/privacy">Privacy</a><a href="/support">Support</a></div>
      </nav>
      <section className="hero wrap" id="top">
        <div>
          ...
          <p className="priceNote">Free to start · Lifetime Pro $5.99 through September 25, 2026 · annual $29.99/year</p>
      ...
      <section className="offer wrap" aria-label="App purchase information">
        ...
        <div className="offerBody"><p>Download and start for free. Create a 7-day plan, then open Execute Toolkit to unlock copyable client templates. US Pro includes the complete project content and action routes: $29.99/year, or Lifetime Pro for $5.99 through September 25, 2026, then $39.99. Final pricing is shown by the App Store.</p><a className="cta light" href={appStoreUrls.offer} target="_blank" rel="noreferrer">Download free <span>↗</span></a></div>
      </section>
