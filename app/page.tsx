    ...
    <main>
      ...
      <section className="hero wrap" id="top">
        <div>
          ...
          <p className="priceNote">Free to start · Annual Pro $29.99/year available now · limited Lifetime Pro $5.99 offer subject to Apple availability</p>
          <div className="heroActions"><a className="cta" href={appStoreUrls.hero} target="_blank" rel="noreferrer">View on the App Store <span>↗</span></a><a className="textLink" href="#projects">Explore the guides <span>→</span></a></div>
        </div>
      ...
      <section className="offer wrap" aria-label="App purchase information">
        ...
        <div className="offerBody"><p>Download and start for free. Create a 7-day plan, then open Execute Toolkit to unlock copyable client templates. Annual Pro is currently available in the US at $29.99/year. Apple may show the limited Lifetime Pro $5.99 offer through September 25, 2026 when that product is available; final pricing and billing details are shown by the App Store.</p><a className="cta light" href={appStoreUrls.offer} target="_blank" rel="noreferrer">Download free <span>↗</span></a></div>
      </section>
